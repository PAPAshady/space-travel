        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-10">
          <div className="relative flex justify-center py-12 md:py-14 lg:flex-1 lg:p-0">
            {destinations.map(({ id, name, image }) => (
              <img
                className={`size-[220px] transition-all duration-500 sm:size-[300px] md:size-[350px] lg:size-[380px] min-[1100px]:size-[450px] ${currentDestination.name === name ? 'visible opacity-100' : 'invisible absolute opacity-0'}`}
                src={image}
                alt={name}
                key={id}
              />
